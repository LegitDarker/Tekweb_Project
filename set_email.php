...
if (isset($_POST['buttonsave'])) {
    ...
    {
        $sql="UPDATE user_data SET email='$newusern' WHERE email='$username'";
    ...
    <div class="wrapper">
            ...
            <div class="signin-box" style="margin-left: -120px; margin-top: 100px; color: white; background: black; opacity: 90%">
                ...
                <div class="mb-3">
                    ...
                    id="username" name="username" value="<?php echo $_SESSION['email'] ?>" readonly="readonly">
                </div>

                <div class="mb-3">
                    <label class="form-label">New Email</label>
                    <input type="text" class="form-control" id="newusern" name="newusern" placeholder="New Email">
