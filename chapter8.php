...
<body>
	...
	<?php } }?>
	 <div class="buttonTop">
                    <a href="chapter7.php"><button type="button" class="btn btn-outline-primary" id="button1" >
                        <h2>Prev Chapter</h2></button>
                    </a>
               


                <a href="chapter9.php"><button type="button" class="btn btn-outline-primary" id="button2">
